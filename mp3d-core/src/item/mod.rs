...
define_items!(
    ...
    PLANKS => { ident: "planks", block: blocks::PLANKS },
    PLANKS_SLAB => { ident: "planks_slab", block: blocks::PLANKS_SLAB },
    PLANKS_STAIRS => { ident: "planks_stairs", block: blocks::PLANKS_STAIRS },
    PLANKS_VSLAB => { ident: "planks_vslab", block: blocks::PLANKS_VSLAB },
